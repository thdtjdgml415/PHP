                    ...
                    <fieldset>
                        ...
                        <div class="join__box">
                            ...
                            <div class="overlap">
                                ...
                                <p class="msg" id="youNickNameComment" id="youNickNameComment"><!--*닉네임이 존재합니다.--></p>
                            </div>
                              <div class="overlap">
                            ...
                            <div>
                                ...
                                <input type="password" id="youPass" name="youPass" placeholder="비밀번호를 적어주세요!" maxlength="15" required>
                                <p class="msg" id="youPassComment"><!--*비밀번호가 일치하지 않습니다.--></p>
                            </div>
                            <div>
                                <label for="youNameC">비밀번호 확인</label>
                                <input type="password" id="youPassC" name="youPassC" placeholder="비밀번호를 다시 적어주세요!" required>
                                <p class="msg" id="youPassCComment"><!--*비밀번호를 다시 확인해주세요--></p>
                            </div>
                            <div>
                                <label for="youBirth">생년월일</label>
                                <input type="text" id="youBirth" name="youBirth" placeholder="YYYY-MM-DD" maxlength="15" required>
                                <p class="msg" id="youBirthComment"><!--*비밀번호를 다시 확인해주세요--></p>
                            </div>
                            <div>
                                <label for="youPhone">휴대폰번호</label>
                                <input type="text" id="youPhone" name="youPhone" placeholder="010-0000-0000" placeholder="번호를 적어주세요!" required>
                                <p class="msg" id="youPhoneComment"><!--*휴대폰 번호가 일치하지 않습니다.--></p>
                            </div>
                        </div>
